...
export const carbonControllerAbi = [
  {
    "anonymous": false,
    "inputs": [
      {
...
export type CarbonController = typeof carbonControllerAbi;
export type CarbonControllerContract = GetContractReturnType<CarbonController, PublicClient>;

export class CarbonController__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: carbonControllerAbi, publicClient: client });
  }
}
